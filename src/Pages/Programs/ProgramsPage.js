...
function ProgramsPage() {
  return (
    <div className="programsPageContainer">
      ...
      <div className="program-head">
            ...
            <div className="workfromhomecontainer">
                ...
                <div className="workfromhome2">
                  <div className="workfromhomeinfo">
                    <div className="workfromhomeinfologo"><img className="startdatelogo" src={Start} alt="" /></div>
                    <div className="workfromhomeinfodetails">
                        <div className="firsthead"><h1 className="firstline">Start Date</h1></div>
                        <div className="secondhead"><h6 className="secondline">Immediately</h6></div>
                    </div>
                  </div>
                  <div className="workfromhomeinfo">
                    <div className="workfromhomeinfologo"><img className="startdatelogo" src={Duration} alt="" /></div>
                    <div className="workfromhomeinfodetails">
                      <div className="firsthead"><h6 className="firstline">Duration</h6></div>
                      <div className="secondhead"><h6 className="secondline">2-4 months</h6></div>
                    </div>
                  </div>
                  <div className="workfromhomeinfo">
                    <div className="workfromhomeinfologo"><img className="startdatelogo" src={Stipend} alt="" /></div>
                    <div className="workfromhomeinfodetails">
                    <div className="firsthead"><h6 className="firstline">Stipend</h6></div>
                    <div className="secondhead"> <h6 className="secondline">No Stipend</h6></div>
                    </div>
                  </div>
                  <div className="workfromhomeinfo">
                    <div className="workfromhomeinfologo"><img className="startdatelogo" src={Apply} alt="" /></div>
                    <div className="workfromhomeinfodetails">
                    <div className="firsthead"><h6 className="firstline">Apply By</h6></div>
                    <div className="secondhead"> <h6 className="secondline">30 Aug'21</h6></div>
                    </div>
                  </div>
                </div>
            </div>
            <div className="aboutinternshipcontainer">
               ...
               <div className="aboutinternshipcontainerbox">
                  <div className="aboutinternshipdetails">
                    <ul>
                      <li className="aboutinternshipline">Lorem, ipsum dolor sit amet consectetur</li>
                      <li className="aboutinternshipline">Lorem, ipsum dolor sit amet consectetur</li>
                      <li className="aboutinternshipline">Lorem, ipsum dolor sit amet consectetur</li>
                      <li className="aboutinternshipline">Lorem, ipsum dolor sit amet consectetur</li>
                    </ul>
                    ...
                    <div className="aboutinternshipinnerbox">
                      ...
                      <h5 className="statusline1">Number of Openings : 6</h5>
                      <h5 className="statusline1">Candidate Applied : 15</h5>
                    </div>
                </div>
        ...
        <div className="function">
          ...
          <div className="function-mini">
            ...
            <div className="dotted-line"></div><div>
              <img src={DownRectangle} />
              <p>3</p>
            </div>
            <div className="dotted-line"></div><div>
